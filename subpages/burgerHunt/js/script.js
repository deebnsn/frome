...
var parseResponseBurgers = function() {
  ...
  for (var i = 0; i<response.response.groups[0].items.length;i++) {
    ...
    info.appendChild(linkBox);
    linkBox.id="linkBox";
    var moreInfo = document.createElement("p");
    linkBox.appendChild(moreInfo);
    moreInfo.id="moInfo";
    moreInfo.innerHTML="For more Information, go to...";
    var foursquareLink = document.createElement("a");
    linkBox.appendChild(foursquareLink);
    var cUrl = response.response.venue.canonicalUrl;
    foursquareLink.href=cUrl;
    foursquareLink.target="_blank";
    var fourSquared = document.createElement("img");
    foursquareLink.appendChild(fourSquared);
    fourSquared.src="images/4.png";
    fourSquared.id="sq4";
  }
